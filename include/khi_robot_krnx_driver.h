...
KHI_ROBOT_KRNX_DRIVER_H is the header file for KHI_ROBOT_KRNX_DRIVER. It initializes the methods for communicating with KRNX.h, the API for the Kawasaki controller
